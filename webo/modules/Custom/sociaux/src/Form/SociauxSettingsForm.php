...
/**
 * Configure sociaux settings for this site.
 */
class sociauxSettingsForm extends ConfigFormBase {

  const SETTINGS = 'sociaux.settings';

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'sociaux_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['networks'] = [
      '#type' => 'container',
      '#prefix' => '<div id="sociaux-networks">',
      '#suffix' => '</div>',
    ];
